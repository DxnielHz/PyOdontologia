...
<body>
    ...
    <div class="container py-4" style="display: flex; flex-direction: row; justify-content: center;">
        <i class="fa fa-tooth me-2 text-primary" style="font-size: 100px;"></i>
        <h1 class="mb-4 text-primary" style="font-size: 100px;">DentCare</h1>
    </div>

    <!-- Banner -->
    <section class="py-5 text-center" style="background-color: var(--primary); color: var(--light);">
        <div class="container">
            <h1 class="display-4">Sobre Nosotros</h1>
            <p class="lead">Conoce más sobre DentCare, tu mejor aliado en salud dental.</p>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-4" style="color: var(--dark);">¿Quiénes Somos?</h2>
            <p class="text-center" style="color: var(--secondary);">En DentCare, nos dedicamos a brindar atención dental de calidad, combinando experiencia profesional con tecnología avanzada para garantizar una experiencia cómoda y efectiva para todos nuestros pacientes.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <h3 class="text-center" style="color: var(--primary);">Misión</h3>
                    <p style="color: var(--dark);">Nuestra misión es proporcionar servicios dentales de alta calidad, promoviendo el bienestar oral a través de un trato humano, profesional y personalizado.</p>
                </div>
                <div class="col-md-6">
                    <h3 class="text-center" style="color: var(--primary);">Visión</h3>
                    <p style="color: var(--dark);">Ser la clínica dental líder en nuestra región, reconocida por la excelencia en el cuidado de la salud bucal y el compromiso con la satisfacción de nuestros pacientes.</p>
                </div>
            </div>
        </div>
    </section>
