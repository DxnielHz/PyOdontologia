...
class PDF extends FPDF
{
   ...
   { 
      ...
      $this->Cell(110, 15, utf8_decode('DentCare'), 0, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE CITAS MEDICAS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(18, 10, utf8_decode('1°'), 1, 0, 'C', 1);
